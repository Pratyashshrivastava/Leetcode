...
# logic: divide the number and store the quotient and remainder
# reverse the remainder array and then convert the int to char with given logic

def decimalToBaseNotation(n, num):
    remainder = []
    quotient = num//n
...
n = 12
num = 718
print(decimalToBaseNotation(n,num))